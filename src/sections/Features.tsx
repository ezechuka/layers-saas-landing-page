            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    <FeatureCard
                        ...
                        description="Engage with clients with prototypes that react
                                to user actions"
                        className="md:col-span-2 lg:col-span-1 group"
                    >
                        <div className="aspect-video flex items-center justify-center">
                    ...
                    <FeatureCard
                        ...
                        description="Powerful commands to help you create design more
                                quickly"
                        className="md:col-span-2 md:col-start-2 lg:col-span-1 lg:col-start-auto items-center group"
                    >
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        <div
                            key={feature}
                            className="bg-neutral-900 border border-white/10 inline-flex px-3 py-1.5 rounded-2xl gap-3 items-center md:px-5 md:py-2 hover:scale-105 duration-500 group"
                        >
